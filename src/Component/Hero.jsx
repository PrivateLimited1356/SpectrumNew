  ...
  return (
    <div className='mt-10 '>
      <div className='relative '>
        ...
        <div className='px-[8vw] absolute top-10  '>
            <p className='text-6xl tracking-tight font-bold'>Fast,Reliable Internet for</p>
            <p className='text-6xl font-bold'>Home Connectivity</p>
           <p className='text-xl mt-8'>Choose Spectrum for the fastest, most reliable home Internet. Bundle with</p>
           <p className='text-xl '>Mobile or TV for monthly savings and a multi-year price guarantee.</p>
